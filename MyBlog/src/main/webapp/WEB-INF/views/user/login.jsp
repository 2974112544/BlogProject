...
<div class="login-box" id="demo">
    <div class="input-content">
        ...
        <form action="${pageContext.request.contextPath}/user/login" method="post" id="form_login">
            <p class="p user_icon">
                <input type="text" placeholder="账号" autocomplete="off" class="login_txtbx" id="userName" name="userName">
            </p>
            <p class="p pwd_icon">
                <input type="text" placeholder="密码" autocomplete="off" class="login_txtbx" id="userPassword" name="userPassword">
            </p>
            ...
            <div class="signup">
                <%--<a class="gv" href="#" onclick="login()">登&nbsp;&nbsp;录</a>--%>
                <%--<a class="gv" href="#" onclick="document:form_login.submit();">登&nbsp;&nbsp;录</a>--%>
                <a class="gv" href="#" onclick="login()">登&nbsp;&nbsp;录</a>
                <a class="gv" href="${pageContext.request.contextPath}/user/toRegister">注&nbsp;&nbsp;册</a>
            </div></form>
