    ...
    <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-right">
            <li class="layui-nav-item">
                <a href="javascript:;">
                    <img src="${sessionScope.user.avatar}" class="layui-nav-img" id="userAvatar">
        ...
        <div style="padding: 15px;">
            <blockquote class="layui-elem-quote">
					<span class="layui-breadcrumb" lay-separator="/">
                           <a href="">文章</a> <a><cite>修改文章</cite></a>
					</span>
            </blockquote>
...
<script>
    $.ajax({
        url:'${pageContext.request.contextPath}/user/getText',
        type:'post',
        ...
        success:function (res) {
                ...
                layui.use([ 'form', 'layedit', 'laydate' ], function() {
                    ...
                    layedit.setContent(editIndex,res)

                    //layedit.setContent(editIndex, text, true);   //flag是true，是追加模式，flag是false，赋值模式
                    //自定义验证规则
                    form.verify({
                    ...
                    form.on('submit(demo1)', function(data){
                        var src = document.getElementById("userAvatar").src;
                        ...
                        $.ajax({
                            url:'${pageContext.request.contextPath}/user/updateBlog',
                            type:'post',
                            data:{
                                "articleID":articleID,
